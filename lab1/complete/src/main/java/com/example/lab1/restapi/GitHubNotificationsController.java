...
public class GitHubNotificationsController {
    ...
    @Autowired
    public GitHubNotificationsController(WebClient webClient, @Value("${github.base.url}") String githubBaseApi) {
    ...
    public String getNotifications(Model model,  
        ...
        Mono<List<GitHubNotification>> notificationsSub = this.webClient
        .get()
